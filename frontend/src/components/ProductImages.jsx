...
function ProductImages({ onImageUpload ,imagestate}) {
...
// If parent component wants to reset the image, we clear the state
  useEffect(()=>{
    if (imagestate === null) {
      setAvatarURL(null);
    }
      ...
      <Row>
        <Col xs={6} md={4}>
          <Card className='mb-3' style={{width:'8rem'}}>
            ...
            <Form.Control type="file" id="item_images"  ref={fileUploadRef} onChange={handleImageChange} hidden accept="image/*" />
